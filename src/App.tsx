...
function App() {
  ...
  console.log("Card clicado agora:", marcoSelecionado);
  
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-[#111827] to-black text-white py-16 px-4 font-sans">
      
      <h1 className="text-4xl md:text-5xl font-extrabold text-center mb-24 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">
        A Evolução da Web
      </h1>
